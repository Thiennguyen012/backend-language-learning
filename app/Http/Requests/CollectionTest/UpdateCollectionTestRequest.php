...
class UpdateCollectionTestRequest extends FormRequest
{
    ...
    {
        return [
            'test_type_id' => 'sometimes|nullable|integer|exists:test_type,id',
            'collection_id' => 'sometimes|nullable|integer|exists:flashcard_collection,id',
            'test_name' => 'sometimes|required|string|max:255',
            'total_questions' => 'sometimes|nullable|integer|min:0',
