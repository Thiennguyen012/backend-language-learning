...
class UpdateUserTestAnswerRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'user_test_attempt_id' => 'sometimes|required|integer|exists:user_test_attempts,id',
            'question_id' => 'sometimes|required|integer|exists:questions,id',
            'user_answer' => 'sometimes|required|string',
            'is_correct' => 'sometimes|required|integer|in:0,1',
        ];
    }
